...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QRect(20, 10, 1671, 981))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ImageLabel.setText(QCoreApplication.translate("Dialog", u"ImageLabel", None))
        self.TextLabel.setText(QCoreApplication.translate("Dialog", u"List of Students", None))
    # retranslateUi
